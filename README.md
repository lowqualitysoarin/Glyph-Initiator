...
| PLAY_GLYPH_ACTION | Plays a glyph action. | - [String] actionKey : The name of your action, should correspond with the entry you added in the Glyph Initiator app. 
- [Boolean] noAudio : Whether you want to play your action with no audio. Default value is "false". |
